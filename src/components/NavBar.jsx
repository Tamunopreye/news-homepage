    ...
    <nav className="p-6 flex justify-between items-center">
      ...
      <div className="block md:hidden">
        <ul
          className={
            !toggle
              ? "bg-white flex flex-col fixed right-[-100%] top-0 h-screen p-6 duration-500 space-y-5"
              : "bg-white flex flex-col fixed right-0 top-0 h-screen p-6 w-8/12 duration-500 space-y-5"
          }
        >
          <li>
            <a className="hover:text-softRed" href="/">
